...
public class MongoClientProviderImpl implements MongoClientProvider {
  ...
  private void configClient(ComponentContext ctx) {
    ...
    this.connectionTimeout = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 100);
    this.cursorFinalizerEnabled = PropertiesUtil.toBoolean(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), true);
    this.description = PropertiesUtil.toString(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), StringUtils.EMPTY);
    this.heartbeatConnectTimeout = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 20000);
    this.heartbeatFrequency = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 10000);
    this.heartbeatSocketTimeout = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 20000);
    this.localThreshold = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 15);
    this.maxConnectionIdleTime = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 0);
    this.maxConnectionLifeTime = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 0);
    this.maxWaitTime = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 120000);
    this.minConnectionsPerHost = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 0);
    this.minHeartbeatFrequency = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 500);
    this.readPreferenceTags =
        PropertiesUtil.toStringArray(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), new String[] {});
    this.readPreferenceType = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 0);
    this.requiredReplicaSetName =
        PropertiesUtil.toString(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), StringUtils.EMPTY);
    this.serverSelectionTimeout = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 30000);
    this.socketKeepAlive = PropertiesUtil.toBoolean(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), false);
    this.socketTimeout = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 0);
    this.sslEnabled = PropertiesUtil.toBoolean(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), false);
    this.sslInvalidHostNameAllowed =
        PropertiesUtil.toBoolean(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), false);
    this.threadsAllowedToBlockForConnectionMultiplier =
        PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 5);
    this.uri = PropertiesUtil.toString(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), StringUtils.EMPTY);
    this.writeConcernFsync = PropertiesUtil.toBoolean(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), false);
    this.writeConcernJ = PropertiesUtil.toBoolean(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), false);
    this.writeConcernW = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 1);
    this.writeConcernWtimeout = PropertiesUtil.toInteger(ctx.getProperties().get(PROP_CONNECTIONS_PER_HOST), 0);
  }
